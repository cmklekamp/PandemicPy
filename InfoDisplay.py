...
class InfoFrame(Frame):
    ...
    def update_info(self):
        ...
        # Outbreak tracker
        self.outbreak_label = Label(self, text="Outbreak tracker: ", font=self.info_font, bg="blue", fg="white")
        ...
        # Infection rate
        self.infection_label = Label(self, text="Infection rate: ", font=self.info_font, bg="blue", fg="white")
        self.infection_label.grid(row=2, column=0, padx=30)
        ...
        self.cure_label.grid(row=3, column=0, padx=30)
        info_string = ""
        ...
        self.eradicate_info.grid(row=4, column=1)
        ...
        self.remaining_label.grid(row=5, column=0, padx=30)
        info_string = ""
        ...
        self.remaining_info.grid(row=5, column=1)       
    ...
    def clear(self):
        items_to_delete_1 = (self.title_text, self.outbreak_label, self.outbreak_info, self.infection_label, self.infection_info)
